module.exports = {
  ...
  spots: [
    ...
    { id: 31, name: "C1", status: 'available', event_id: 3 },
    { id: 32, name: "C2", status: 'available', event_id: 3 },
    { id: 33, name: "C3", status: 'available', event_id: 3 },
    { id: 34, name: "C4", status: 'available', event_id: 3 },
    { id: 35, name: "C5", status: 'available', event_id: 3 },
    { id: 36, name: "C6", status: 'available', event_id: 3 },
    { id: 37, name: "C7", status: 'available', event_id: 3 },
    { id: 38, name: "C8", status: 'available', event_id: 3 },
    { id: 39, name: "C9", status: 'available', event_id: 3 },
    { id: 41, name: "C10", status: 'available', event_id: 3 },
    { id: 42, name: "C11", status: 'available', event_id: 3 },
    { id: 43, name: "C12", status: 'available', event_id: 3 },
    { id: 44, name: "C13", status: 'available', event_id: 3 },
    { id: 45, name: "C14", status: 'available', event_id: 3 },
    { id: 46, name: "C15", status: 'available', event_id: 3 },
  ]
};
